...
這個 repo 收錄 Google Antigravity IDE 2.0 使用者可公開套用的服務連接與工作流程教學。每個功能都有一份完整說明檔，以及一個對應的 Agent Skill。
...
| 編號 | 完整說明 | 對應 Skill | 說明 |
|---|---|---|---|
| 00 | [一次安裝全部](00-一次安裝全部.md) | 安裝派送入口，不另行安裝 | 逐項安裝與回報六個功能 Skill |
...
檢查內容包括章號、六個 Skill 與 manifest 一對一、安裝器模擬、Markdown 連結、JSON 範例、frontmatter、固定規則入口、全域 Skill 路徑、舊指令、敏感資料樣式、UTF-8、PowerShell／Python 語法，以及發布必備檔案。
