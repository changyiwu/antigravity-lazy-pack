...
def draw_image(prompt, output_path, size="1024x1024", model="gpt-image-2"):
    api_key = get_api_key()
    if not api_key:
    ...
    print(f"Sending request to OpenAI (Model: {model}, Size: {size})...")
...
if __name__ == "__main__":
    ...
    draw_image(args.prompt, args.output, args.size, args.model)
